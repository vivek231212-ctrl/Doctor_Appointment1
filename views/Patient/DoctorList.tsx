...
export const DoctorList: React.FC<{ onSelect: (id: string) => void }> = ({ onSelect }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F8FAFC]">
      ...
      <button className="fixed bottom-28 right-6 w-16 h-16 bg-[#25D366] rounded-full shadow-xl shadow-green-100 flex items-center justify-center text-white active:scale-95 transition-all z-20">
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-50 h-[88px] px-10 flex items-center justify-between z-30">
